...
class Solution {
    public int swimInWater(int[][] grid) {
        ...
        while (!minHeap.isEmpty()) {
            ...
            int r = top[0], c = top[1], maxSoFar = top[2];
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (newRow < 0 || newRow >= n || newCol < 0 || newCol >= n || visited[newRow][newCol]) continue;
                
                minHeap.offer(new int[]{newRow, newCol, Math.max(maxSoFar, grid[newRow][newCol])});
            }
        }
